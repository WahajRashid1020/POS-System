...
export function OrderSuccessModal({
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-[360px] rounded-2xl bg-white p-8 text-center shadow-2xl">
        {/* Success icon */}
        ...
        <h2 className="text-xl font-bold text-ink">Order Placed!</h2>

        <div className="mt-4 rounded-xl bg-stone-50 p-4">
          <p className="text-sm text-ink-secondary">Order Number</p>
          <p className="text-3xl font-bold text-brand-600">#{orderNumber}</p>
        </div>
